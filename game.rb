...
class Game
  attr_accessor :p1, :p2, :current_round 
  MAX_ROUNDS = 20
...
puts "input users name"
game = Game.new(gets.chomp, gets.chomp)

  while game.current_round > 0 && game.p1.check_if_alive && game.p2.check_if_alive do
    game.next_round
    game.next_round
  ...
  if game.p1.check_if_alive && game.p2.check_if_alive
    puts "Tie"
  elsif game.p1.check_if_alive
